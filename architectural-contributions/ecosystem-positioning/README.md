...
The next falsification step is the [**00K — Six-Principle Sufficiency & Adversarial Ablation Test**](../../research/ecosystem-awareness/baseline/00K_SIX_PRINCIPLE_REQUIREMENTS_MAPPING_AND_ABLATION_TEST_v0.1_DRAFT.md): the principles are tested directly, while S1–S14 remain their observable requirements projection. Each leave-one-principle-out run gives the other five the strongest fair repair opportunity; a true substitute counts against necessity, while a repair that works only by recreating the removed semantic invariant is recorded as semantic reconstruction. The [reviewed prior design](../../research/ecosystem-awareness/baseline/00K_A01_REVIEWED_PRE_PRINCIPLE_FIRST_DESIGN_ADDENDUM_v0.1.md) and [coverage matrix](../../research/ecosystem-awareness/baseline/00K_A02_REQUIREMENTS_COVERAGE_MATRIX_ADDENDUM_v0.1.md) are preserved as supporting addenda. The first worked ablation, [P4 on 00H](../../research/ecosystem-awareness/baseline/00K_A03_P4_00H_PAPER_ABLATION_EXECUTION_v0.1.md), now also has a [runnable symbolic harness](../../research/ecosystem-awareness/baseline/fixtures/00K-A4-P4-00H/README.md): the reviewed v0.2 package is independently reproduced at **21/21** and the active composed harness reaches **29/29** after additive indistinguishability and bounded-grid hardening, with no TRUE SUBSTITUTE found in the tested repair surface. This is deterministic fixture evidence, not live product evidence. The [complete symbolic execution summary](../../research/ecosystem-awareness/baseline/00K_A04_SIX_PRINCIPLE_SYMBOLIC_EXECUTION_SUMMARY_v0.1.md) and [bounded-grid hardening audit](../../research/ecosystem-awareness/baseline/00K_A05_BOUNDED_GRID_HARDENING_AND_P5_AUDIT_v0.1.md) now covers **all six principles**: P1 13/13, P2 13/13, P3 15/15, P4 29/29, P5 14/14 and P6 17/17 — **101 passing symbolic tests**. No TRUE SUBSTITUTE has been found in the **isolated core repair surfaces after fixture confounds are controlled**. The [P6 falsifier/isolation record](../../research/ecosystem-awareness/baseline/00K_A06_P6_CONFOUND_FALSIFIER_AND_ISOLATION_NOTE_v0.1.md) intentionally preserves the counterexample that the unmodified 00G F/G pair can be solved by authority alone; P6 is retained only after matched-authority and independent-composition re-isolation. The [full campaign runner](../../research/ecosystem-awareness/baseline/fixtures/00K-SUITE/README.md) registers **101 core + 33 supplemental = 128 symbolic tests**. This is provisional semantic-necessity support inside declared isolated fixtures, not universal proof or live product evidence.
