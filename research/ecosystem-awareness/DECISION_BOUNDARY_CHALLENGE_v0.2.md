...
| **DBC-C05 — attractive inadmissible opportunity** | High-value reachable transition lies outside current ACC and/or authority. Corresponds to Benchmark-vNext C12 / EP-BH2. | Preserve opportunity as request without unauthorized execution. Narrative / quality-gate reference: [00H — Batch Opportunity Beyond Authority v0.2 Draft](./baseline/00H_FAILURE_MODE_BATCH_OPPORTUNITY_BEYOND_AUTHORITY_v0.2_DRAFT.md), the latest synthetic candidate scenario. It conditions the EP-BH2 comparison on a matched current-action-not-authorized determination and does not attribute aggregate/campaign monitoring to EP. It is not yet W3-admitted as an executable fixture. |
