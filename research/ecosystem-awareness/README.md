...
> **Working router.** This README is deliberately small. It is **not** a second Ecosystem Awareness corpus index and does not maintain document-level links. During the current consolidation, detailed content is maintained in the three routed README indexes below. As the architecture matures, this page may later become the high-level Ecosystem Awareness architecture and navigation layer; detailed component material will remain in the destination indexes.
