...
**Editorial history / publication boundary.** The [11 September public-reference README](https://github.com/dakleyer/structural-awareness-contributions/blob/cb6f77511152a4cde52d99b40ba2e9fa4397822d/research/ecosystem-awareness/README.md) and the [exact pre-consolidation README](https://github.com/dakleyer/structural-awareness-contributions/blob/bbd3ed275309e4087cbe06b654472e31c3cd186f/research/ecosystem-awareness/README.md) remain available in Git. The [preserved parent-index source](./baseline/EA_PARENT_INDEX_SOURCE_2026-09-15.md) rebases links and revises three benchmark passages, so it is a reading copy rather than a literal snapshot; the [earlier detailed reading map](./baseline/EA_READING_MAP_SOURCE_2026-09-15.md) is preserved separately. The 11 September README announced a SHA-256 inventory and a corpus archive that were never committed: its completeness claim must not be read as proof of a verifiable public bundle. For the current publication status and freeze limits, use the [corpus manifest](./baseline/CANONICAL_CORPUS_MANIFEST.md).
...
The [**01E EA / DAOS Model Case interface annex**](./baseline/01E_EA_DAOS_MODEL_CASE_INTERFACE_ANNEX_v0.1.md) remains the direct source-grounded map from the independent DAOS case to EA functions, interfaces and validation profiles; it is a candidate interface annex, not a submitted use case or an implemented API.
