...
- [00H — batch opportunity beyond authority / "The Quiet Four Thousand"](./baseline/00H_FAILURE_MODE_BATCH_OPPORTUNITY_BEYOND_AUTHORITY_v0.2_DRAFT.md) — latest working draft for C12 / DBC-C05; separates control prerequisite from EP-BH2 causal attribution, adds concrete materiality, bounded authority closure, negative controls and gate×variant coverage; not yet W3-admitted.
...
| Candidate opportunity / authority scenario 00H | [00H](./baseline/00H_FAILURE_MODE_BATCH_OPPORTUNITY_BEYOND_AUTHORITY_v0.2_DRAFT.md) | **Latest working draft v0.2** — causal split, strong-peer and coverage controls added; W3 admission/execution pending |
...
**DBC-C05 narrative scenario:** [00H — Batch Opportunity Beyond Authority](./baseline/00H_FAILURE_MODE_BATCH_OPPORTUNITY_BEYOND_AUTHORITY_v0.2_DRAFT.md) gives the attractive-inadmissible-opportunity branch a bounded synthetic case and Q0–Q5 quality-gate plan. It remains a candidate scenario, not an executed result.
