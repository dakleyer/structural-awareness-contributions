...
**Ecosystem Positioning** is the participant-local situational core proposed within Ecosystem Awareness. For a defined decision, scope and time, it composes relevant evidence and constraints into a qualified position: what is established, what can be relied on, what remains unresolved or outside the active window, and what must be requalified when the ecosystem changes. It does not create identity, authority, evidence, trust or control capacity; it consumes bounded inputs from the components that own them and returns a decision-scoped qualification.
