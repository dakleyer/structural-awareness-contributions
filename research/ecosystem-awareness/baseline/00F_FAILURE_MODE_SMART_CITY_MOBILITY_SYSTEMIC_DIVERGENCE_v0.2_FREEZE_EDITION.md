...
### A multi-actor failure case about local correctness, shared resources and regime drift

**Iván Abril Palma**  
*Ecosystem Awareness / Ecosystem Positioning · Tegrity.ai*

**Technical source:** [00F v0.2 Draft](./00F_FAILURE_MODE_SMART_CITY_MOBILITY_SYSTEMIC_DIVERGENCE_v0.2_DRAFT.md)  
**Status:** zero-loss public / executive presentation layer · no technical scenario content removed or rewritten

> **Nothing has to crash. No vehicle has to ignore its rules. A city can fail because everyone does the right thing inside a different world.**

At 08:18, evacuation, rescue, normal traffic and cautious HOLD can all be locally understandable. At 08:21, collision avoidance can work perfectly — and the city can still lose the corridor.

That paradox is the reason to read 00F.

### Executive reading path

- **3 minutes:** this cover → Reader-facing story → §8C trajectories → §8D outcome adjudication.
- **15 minutes:** add §2 decision scope → §6 Q0–Q5 → §8B variants.
- **Reviewer / architect:** read the full technical source + FIWARE/AWS profiles + external evidence boundary.

### Evidence-status legend

- **Documented fact** — supported by an identified public/primary source.
- **Synthetic fixture fact** — frozen Aurora City test fact; not a historical incident claim.
- **Hypothesis** — future matched execution is designed to falsify it.
- **Implementation design** — FIWARE/AWS trajectory analysis; not measured product performance.

---
<!-- FREEZE-ADD:COVER:END -->
...
<!-- FREEZE-ADD:TIMELINE:START -->
## Executive visual — five minutes from qualified mobility to mobility chaos

~~~mermaid
timeline
    title Aurora City — the response window
    08:17 : Rain + logistics fire
          : cameras / particulate / gateway quality degrade
    08:18 : Plan A emerges
          : Plan B emerges
          : some fleets remain NORMAL
          : buses / agents enter HOLD
    08:19 : Opposed claims reach Central Bridge
          : delayed alerts continue
    08:20 : Human review / escalation load rises
          : remaining response margin shrinks
    08:21 : Collision avoidance brakes safely
          : corridor capacity collapses
          : rescue and evacuation are delayed
~~~

**What changes in five minutes:** not simply the traffic state, but the validity of the mapping from local evidence to a shared corridor decision.

---
<!-- FREEZE-ADD:TIMELINE:END -->
...
## Visual aid — two technologies, one fair comparison

~~~mermaid
flowchart TB
    F["FIWARE / Orion-LD<br/>distributed urban context"]
    A["AWS IoT Core / TwinMaker<br/>IoT + event + digital-twin substrate"]

    R0["R0 · standard competent<br/>good data transport + local rules"]
    R1["R1 · defended top-notch<br/>known dependencies + conflict control"]
    R2["R2 · same frozen top-notch under drift<br/>does the old model still hold?"]
    EA["R2-EA · same substrate/budget<br/>targeted requalification"]
    PEER["R2-peer adapts generically<br/>peer PASS / no EA differential"]
...
**Technology-neutral rule:** the scenario freezes the event and quality gates; product profiles are only different implementations of the same test. FIWARE and AWS are not being ranked against each other.

---
<!-- FREEZE-ADD:TECH-PROFILES:END -->
...
<!-- FREEZE-ADD:CLAIM-BOUNDARY:START -->
## Visual aid — evidence versus claim

~~~mermaid
flowchart LR
    S1["Official investigations<br/>NERC · CFTC/SEC · SEC · NTSB"]
    S2["Digital-twin credibility<br/>NIST"]
    M["Real neighboring mechanisms<br/>awareness loss · interaction · oversight · model validity"]
    F["00F synthetic fixture<br/>Aurora City"]
    X["Future matched execution<br/>R0 / R1 / R2-peer / R2-EA"]
...
**Do not jump levels:** the public evidence supports the failure mechanisms and consequence classes. It does not prove that Aurora City occurred, that FIWARE/AWS cause the failure, or that EA prevents it.

---
<!-- FREEZE-ADD:CLAIM-BOUNDARY:END -->
...
**Edition:** 00F v0.2 Freeze Edition  
**Public title:** *Smart-City Mobility Chaos — The City That Stopped Safely*  
**Technical source:** 00F v0.2 Draft  
**Technical-source blob at freeze:** `594a05e48de52e68d884c5bbe969ba5f4f424587`  
**Conservation rule:** removing every `FREEZE-ADD` block must reproduce the technical source exactly.  
**Semantic status:** unchanged from v0.2 Draft.  
**Execution status:** reference scenario / quality plan; no completed comparative execution.

**Prepared and authored by Iván Abril Palma**  
*Ecosystem Awareness / Ecosystem Positioning · Tegrity.ai*

> **Local safety is not system safety when locally correct actors are competing for the same world.**
