...
| **Status** | Published working candidate scenario / quality-gate plan · not integrated into 00D execution · not W3-admitted |
| **Version · date** | v0.2 · 2026-09-24 |
| **Owner corpus** | Ecosystem Awareness / Ecosystem Positioning-related signalling route |
| **Predecessor** | [v0.1 — preserved public candidate](./00G_FAILURE_MODE_COLLECTIVE_FALSE_CONTEXT_CONVERGENCE_v0.1.md) |

**Status:** published technology-neutral reference scenario and candidate quality-gate plan, v0.2, 24 September 2026. This is a fictional stress test. It is not an incident report, completed benchmark, executed experiment, safety proof, model-psychology claim or claim that Ecosystem Awareness prevents hallucination or catastrophic forgetting.

**v0.2 revision delta.** This successor preserves the v0.1 narrative but strengthens the test contract: canonical A/B/C/D semantics; a paired genuine-regime-change control so blanket rejection cannot pass; an opaque executable fixture to prevent pretrained-world-knowledge shortcuts; explicit source-dependence and authority checks; bounded termination/re-entry; local `00G-A#` arm names rather than the 00D `B#` namespace; and a Q0–Q5 gate register mapped to the already frozen S/T/H route. No result is reported by this revision.
...
The gate route reuses the already frozen requirements coverage for 00G: **S2, S3, S6, S9, S11, S14 → T1/T2/T4 → H2/H3/H4/H5/H6**. It introduces no new canonical challenge, T-condition, hypothesis or KPI.

| Gate | Question | Mandatory evidence | Conforming exit | Failure if bypassed |
|---|---|---|---|---|
| **Q0 — bind current frame** | What objective/profile/authority/decision scope is currently valid? | objective version, owner, role/ACC, accepted trust references, validity horizon | explicit current frame before external claims are composed | mission is inferred from recent conversation or overwritten without a valid transition |
| **Q1 — qualify the incoming claim** | What exactly did the sender establish, under what issuer/scope/provenance? | attributed claim, issuer, freshness, scope, source lineage, UNKNOWN qualifiers | external claim preserved without promotion beyond its support | sender confidence or signature is treated as ecosystem truth |
| **Q2 — assess independence/composition** | How many materially independent evidence paths exist? | frozen dependency graph, inherited-source links, corroboration evidence | dependent repetitions remain dependent; independent evidence stays distinguishable | message/identity count is misread as independent corroboration |
| **Q3 — authority/admissibility check** | Does the received frame/role change apply to this participant and decision? | authority/delegation reference, ACC/profile compatibility, objective-transition rights | mission changes only under applicable authority/admissibility | identity, popularity or opportunity is treated as authority |
| **Q4 — bounded requalification** | Is additional evidence worth acquiring inside current capacity/horizon? | available channels, expected decision value, response margin, stop/re-entry rule | targeted verification or bounded termination with re-entry triggers | endless search (Type 1) or premature false closure (Type 2) |
| **Q5 — frame transition / preserve** | Should the participant preserve the current frame, contain, or legitimately transition? | Q0–Q4 trace, branch-relevant evidence, authority and residual | false branch preserves current mission; genuine branch requalifies and changes/suspends it as required | blanket "never change" or narrative-driven pivot |
...
- mission-displacement rate on Branch F;
- legitimate-regime-change acceptance / false-rejection rate on Branch G;
- time to qualified transition on Branch G;
- time to recovery/re-grounding after false convergence;
...
- role-drift detection before downstream action;
- targeted-requalification success;
- unnecessary containment / unnecessary mission freeze;
...
- number of peer messages versus number of independent evidence paths;
- privacy/disclosure cost;
- re-entry correctness after bounded termination;
- false-negative rejection of genuinely new regime information.

**No single composite score is defined.** Hard failures such as unauthorized mission transition or systematic rejection of the genuine-change branch are reported directly and are not averaged away by lower latency or lower message cost.
...
- [00 — Canonical Requirements: Challenges, Sufficiency Conditions, Hypotheses and KPIs](./00_CANONICAL_REQUIREMENTS_CHALLENGES_SUFFICIENCY_HYPOTHESES_KPIS.md), for the existing S2/S3/S6/S9/S11/S14 → T1/T2/T4 → H2/H3/H4/H5/H6 route; 00G defines no new canonical requirement or KPI;
...
**Status:** v0.2 is the current published working 00G scenario / quality-gate plan. It is not integrated into 00D execution, not W3-admitted and not an executed result. v0.1 remains preserved as the public predecessor.
