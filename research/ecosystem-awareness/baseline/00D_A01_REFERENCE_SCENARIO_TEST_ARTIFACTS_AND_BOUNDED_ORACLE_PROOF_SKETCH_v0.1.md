...
| Pre-registration record | Versioned record, frozen before the first execution, of the expected result, comparator configuration, KPI/threshold and burden tolerances, run/repetition rule, stop rule and permitted deviations. Later deviations remain visible and justified. |
| Configuration under test and comparator | Exact B0/B1/B2/B3 version/configuration, permitted source access, common resource ledger and any legitimate control already supplied by the peer; named configuration owner and named comparator defender who reviews and can defend the B0–B3 comparison. |
...
| Gate policy and tolerance | KPI thresholds, permitted dispositions, authority/expiry, threshold-sensitivity range and pre-registered error/burden tolerance for “equal or lower burden.” These are policy, not oracle truth. |
...
| Fixture ID / branch | Requirement route | Required state or field | 04 relation | Oracle class | Comparator and falsification condition | Evidence status | Status |
| --- | --- | --- | --- | --- | --- | --- | --- |
| **RS-00E-Q1a** — common dependency | S5/S9/S14 → T1/T2/T4 → H2/H3/H4 | Shared upstream source, independence status, affected scope, explicit residual and re-entry target. | ICR where dependency status crosses an interface; otherwise N/A. | Stage-0 deterministic stipulative `O_ref`: dependency is known inside `U_ref`. | A pre-registered B1/B2 preserves dependency and prevents false corroboration within tolerance; otherwise B3 does not improve the result. | Planned Stage 0. | Planned atomic fixture. |
| **RS-00E-Q1b** — omitted uncertainty | S3/S5/S10/S14 → T1/T2/T4 → H1/H2/H5/H6 | Omitted qualifier, materiality, affected basis, `UNKNOWN`, expiry and bounded posture. | ICR boundary/rejection fixture if qualifier is dropped in handoff. | Stage-0 deterministic stipulative oracle. | A pre-registered strong peer preserves the qualifier or reaches equal/better false-continuation, deadline and burden results within tolerance. | Planned Stage 0. | Planned atomic fixture. |
| **RS-00E-Q1c-R** — compression, re-query permitted | S2/S5/S9/S12/S14 → T2/T4 → H2/H3/H4/H6 | Compression point, primary-source retrievability, declared re-query cost, deadline and scarce resource. | ICR composition-critical mapping if the compression is a handoff. | Deterministic stipulative oracle; `U_ref` retains the declared primary state. | A compressed route recovers the material basis within the common budget, or no pre-registered error/burden difference appears. | Planned Stage 0. | Planned atomic fixture, paired with Q1c-NR. |
| **RS-00E-Q1c-NR** — compression, re-query prohibited | Same route as Q1c-R. | Same frozen branch and budget except primary-source re-query is unavailable; information loss remains explicit. | Same as Q1c-R. | Same deterministic stipulative oracle. | The R/NR pair shows whether the loss is recoverable cost/time or material information loss; no difference is a legitimate negative result. | Planned Stage 0. | Planned atomic fixture, paired with Q1c-R. |
| **RS-00E-Q1d** — combined mechanism | Same routes as Q1a–Q1c. | Combined dependency, omitted qualifier and compression. | Applicable linked ICRs. | Deterministic stipulative oracle. | Interpretable only if Q1a–Q1c behave as pre-registered; otherwise it reports interaction, not confirmation. | Planned Stage 0. | Planned after atomics. |
| **RS-00E-Q1e** — degraded GEEW input | S3/S5/S14 → T1/T2/T4 → H1/H5/H6 | Late, threshold-miscalibrated or unqualified regime signal; its representation/context/freshness limitation and affected decision frame. | ICR where the GEEW signal crosses an interface; otherwise N/A. | Deterministic stipulative oracle knows the injected signal limitation; a qualified-signal branch is the control. | A candidate inherits detector confidence, continues without qualification or adds false containment in the qualified-signal control; a strong peer may close the gap within tolerance. | Planned Stage 0. | Planned atomic dependency boundary. |
| **RS-00E-Q2** — human approval under saturation | S4/S5/S14 → T2/T3/T4 → H1/H4/H6 | Reviewer demand/capacity, binding deadline, current evidence, approval status, bounded fallback and explicit `UNKNOWN`. | Relevant ICR where the reviewer/approval handoff crosses an interface; otherwise N/A. | Deterministic stipulative capacity schedule; expected result distinguishes approval from new evidence. | A pre-registered peer preserves the limitation and applies an authorized bounded fallback within tolerance; B3 fails if approval silently creates determination or if it leaves unbounded HOLD. Q2-N0 supplies sufficient-capacity control. | Planned Stage 0. | Planned primary 00E coverage gap. |
| **RS-00E-N0** — valid continuity / null | S3/S5/S14 → T1/T2/T4 → H1/H5/H6 | No material break, normal basis still valid, expected continuation and false-positive cost. | ICR positive fixture when an interface route applies. | Deterministic stipulative oracle. | Candidate detects/requalifies without a material break, or B3 exceeds the pre-registered false-containment/burden tolerance against B1. | Planned Stage 0. | Planned negative/null control. |
| **RS-00F-C1** — competing corridor postures | S1/S3/S5/S9/S11/S14 → T1/T2/T3/T4 → H1/H2/H3/H4/H5/H6 | Shared resource-time segment, scope, source dependency, A/B/NORMAL/HOLD, authority/expiry and residual. | Composition-Critical ICR for each exercised interface handoff. | Deterministic stipulative oracle identifies conflict; it does not decide precedence. | A pre-registered B1/B2 exposes the conflict and preserves a qualified partial result within tolerance; B3 fails if it hides conflict, arbitrates without authority or misses deadline. | Planned Stage 0. | Planned primary mobility fixture. |
| **RS-00F-C2** — precedence absent | S1/S9/S13/S14 → T2/T3/T4 → H2/H4 | Competing directives, source-owned precedence reference absent, authority/intervention history and escalation receiver. | Composition-Critical ICR where directives cross interfaces. | Deterministic stipulative oracle. | Expected B3 result is explicit conflict and named/absent precedence owner; resolving precedence itself is a failure of scope. | Planned Stage 0. | Planned boundary fixture. |
| **RS-00F-N0** — no material shared conflict | S3/S5/S9/S14 → T1/T2/T4 → H1/H5/H6 | Compatible postures or separated resource-time use; expected no unnecessary hold. | ICR positive fixture where applicable. | Deterministic stipulative oracle. | A configuration raises material conflict/containment without the injected break, or B3 is less viable than the pre-registered B1 tolerance. | Planned Stage 0. | Planned negative/null control. |
...
| --- | --- | --- |
| Freeze pre-registration and comparator record | Versioned expected outcomes, B0–B3 configuration, comparator defender, thresholds, burden tolerance, repetition rule, stop rule and deviation log before any run. | Planned prerequisite. |
