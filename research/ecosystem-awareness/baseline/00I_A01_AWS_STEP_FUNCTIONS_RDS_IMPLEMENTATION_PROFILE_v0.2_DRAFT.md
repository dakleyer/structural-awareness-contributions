...
| **Parent scenario** | [00I — Semantic TOCTOU / “The Patch That Undid the Fix” v0.5 Draft](./00I_FAILURE_MODE_SEMANTIC_TOCTOU_v0.5_DRAFT.md) · [Freeze Edition](./00I_FAILURE_MODE_SEMANTIC_TOCTOU_v0.5_FREEZE_EDITION.md) |
