...
| **Companion trajectory** | [00H-A02 — Stripe Radar v0.2 Draft](./00H_A02_STRIPE_RADAR_IMPLEMENTATION_PROFILE_v0.2_DRAFT.md) |
| **Predecessor** | [v0.1 Draft](./00H_A01_CLAUDE_AGENT_SDK_IMPLEMENTATION_PROFILE_v0.1_DRAFT.md) |
...
**v0.2 delta.** Aligns the Claude trajectory with 00H v0.3's adaptive strong-peer family V14–V18. It does not weaken the peer: H1 may use authoritative external principal/grant state and cumulative ledgers. H2 now tests whether those previously correct mappings remain valid after principal binding, delegated-campaign membership or aggregation relations change.
...
**Status:** source-reviewed v0.2 implementation-trajectory draft aligned to 00H v0.3; unexecuted; no product-failure claim, benchmark result or comparative-superiority claim.
