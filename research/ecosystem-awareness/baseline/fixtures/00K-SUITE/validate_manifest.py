...
This is a meta-integrity check. It is not counted in the 379 ablation tests.
"""
...
def main() -> int:
    ...
    if core != data["core_expected_tests"] or core != 346:
    ...
    if total != data["campaign_expected_tests"] or total != 379:
