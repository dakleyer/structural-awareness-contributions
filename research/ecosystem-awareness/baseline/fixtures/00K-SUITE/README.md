...
The earlier A1 / 00J, A2 / 00E and A3 / 00F variants are [restored byte for byte in the historical fixture archive](../00K-HISTORICAL/README.md), with their original commit sources and an independent **32/32** replay. They were removed from the current harness directories as duplicate variants, but their fixtures and assertions are **not byte-identical** to the current A1–A3 harnesses. These 32 historical assertions are **not included** in the 379 current campaign tests or its CI claim.
