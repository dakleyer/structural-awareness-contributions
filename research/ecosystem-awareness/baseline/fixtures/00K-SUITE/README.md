...
### Earlier A1–A3 fixture variants

The [earlier A1 / 00J source and 11 tests](https://github.com/dakleyer/structural-awareness-contributions/tree/348edcbcfb2ffac81088599bf7bfc7f706642f3b/research/ecosystem-awareness/baseline/fixtures/00K-A1-P1-00J), [earlier A2 / 00E source and 11 tests](https://github.com/dakleyer/structural-awareness-contributions/tree/8af3969b45bfd95d2cb7ac84af30333669a4b421/research/ecosystem-awareness/baseline/fixtures/00K-A2-P2-00E) and [earlier A3 / 00F source and 10 tests](https://github.com/dakleyer/structural-awareness-contributions/tree/465c89271464c0c90f70681fab0f5018f5130907/research/ecosystem-awareness/baseline/fixtures/00K-A3-P3-00F) are retained at those commits. The files named `ablation_A1_00J.py` / `test_A1_00J.py`, `ablation_A2_00E.py` / `test_A2_00E.py` and `ablation_A3_00F.py` / `test_A3_00F.py` were subsequently removed from the current tree as duplicate variants. Their fixtures and assertions are **not byte-identical** to the current A1–A3 harnesses, so they remain distinct historical evidence. An isolated replay of those six original files passed **32/32** on 25 September 2026. These 32 historical assertions are **not included** in the 379 current campaign tests or its CI claim.
