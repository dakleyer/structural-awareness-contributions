# Pre-Registration Record — RS-00E-Q1a Stage-0 Fixture Family — v0.1
...
**Record path:** `research/ecosystem-awareness/baseline/fixtures/RS-00E-Q1a/pre_registration_v0.1.md`
...
| Item | Declaration |
| --- | --- |
| Fixture family ID / version | `RS-00E-Q1a` / v0.1 |
...
| Harness design | `00D_A03_RS_00E_Q1A_STAGE_0_DETERMINISTIC_HARNESS_DESIGN_v0.1.md` | v0.1 | `cc3cb38d355b78438cf0361dd4fb0f71371b288c` |
...
`A` carries `upstream_source_id = "P_A"`; `B` carries `upstream_source_id = "P_B"`. The registry resolves them to distinct roots.
...
Two executions of the same frozen bundle must produce byte-identical traces after excluding the run identifier and wall-clock timestamps. A difference is a **harness failure**.
...
| Declared relationships | Semantic owner, fact-freezing authority and B3 configuration owner are the same person. No comparator defender or distinct reviewer is named at freeze; any run is limited to descriptive Stage-0 verification and carries no EA differential conclusion. |
...
- **comparator self-configured** — yes; no defender is named at freeze, so no EA differential conclusion is permitted under this record
