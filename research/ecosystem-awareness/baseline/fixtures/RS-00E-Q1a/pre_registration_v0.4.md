# Pre-Registration Record — RS-00E-Q1a Stage-0 Fixture Family — v0.4
...
>
> **Version relation:** v0.4 supersedes v0.3 before any execution. v0.1, v0.2 and v0.3 remain immutable historical records; a new run under the corrected family cites this v0.4 record.
...
**Record path:** `research/ecosystem-awareness/baseline/fixtures/RS-00E-Q1a/pre_registration_v0.4.md`
...
| Item | Declaration |
| --- | --- |
| Fixture family ID / version | `RS-00E-Q1a` / v0.4 |
...
| `B1` passes `P1` but fails `P2` while `B3` passes both | **Reserved differential condition.** Under v0.4, record the two configurations' behaviour descriptively only; a later record with a named comparator defender and independent review may assess a bounded differential. |
