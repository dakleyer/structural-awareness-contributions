...
The [Stage-0 workflow](../../../../../.github/workflows/rs-00e-q1a-stage0.yml) replays both controls and all 12 branches on the PR integration tree, then compares each file byte for byte. Its run URL and checkout SHA must be recorded after CI completes; a later workflow success does not retroactively turn this local descriptive execution into product evidence.
