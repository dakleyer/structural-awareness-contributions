...
1. [Validation Profile Family & Traceability v0.5](./VALIDATION_PROFILE_FAMILY_v0.5_FROZEN.md) — frozen family and artifact-type/publication boundary.
2. [UC‑EA‑01 v0.3 — action-time operating-frame requalification](./UC-EA-01_v0.3_FROZEN.md) — frozen.
...
These are **Architecture-Validation Profiles**, not four FG-TIDA Use Case submissions. The parent [TIDA — Delegated Authority OS under Context Change package](../../../submissions/itu-fg-tida/2026-theme-contributions/delegated-authority-os-under-context-change/README.md) is public pre-freeze working material; its mobility Annex I is the minimum instantiation, and Annex II controls extensions. A future concrete external mobility Use Case remains a separate artifact. None of the profiles or proposed tests is represented here as completed validation, adoption or an ITU-T deliverable.
