...
The six principle ablations now have executable symbolic harnesses. The [execution campaign summary](./00K_A04_SIX_PRINCIPLE_SYMBOLIC_EXECUTION_SUMMARY_v0.1.md) records a **209-test core regression surface** plus **33 supplemental falsification / isolation / cross-scenario tests**.
