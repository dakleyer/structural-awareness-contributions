...
**Pendiente para evidencia más fuerte:** [Stage 0/RS-00E-Q1a](../fixtures/RS-00E-Q1a/EXECUTION_RECORD_v0.5.md) tiene ahora dos controles y doce trazas deterministas Q1a, con empate B1/B3; sigue pendiente reproducción/revisión independiente. Después, peer fuerte y comparaciones B0–B3 con presupuesto y oráculo aislado, revisión independiente y mediciones reales si se formulan afirmaciones sobre productos. No inferir diferencial EA de este registro.
