...
| **A5 / −P5** | Material-change requalification at time of use | **00I — Semantic TOCTOU, exhaustive material-basis grid** | continuity + unavailable source + every single-field material mutation | **47/47** | full basis compare, hash/vector, complete event invalidation or material epoch | **SEMANTIC RECONSTRUCTION of P5** |
| **A6 / −P6** | No local→ecosystem promotion / non-substitution | **00G — matched-authority + transitive-dependency isolation** | same authority/identities/orgs/immediate-source-count/confidence/freshness/time/content; hidden common root vs independent roots | **74/74** | transitive dependency graph / effective material-root peer | **SEMANTIC RECONSTRUCTION of P6** |

**Current core after serious-repair hardening of all six principles:** **346 passing symbolic tests** across the six isolated principle harnesses.
