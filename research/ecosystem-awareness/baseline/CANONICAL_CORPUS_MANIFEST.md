...
- [`baseline/00G_FAILURE_MODE_COLLECTIVE_FALSE_CONTEXT_CONVERGENCE_v0.3_DRAFT.md`](./00G_FAILURE_MODE_COLLECTIVE_FALSE_CONTEXT_CONVERGENCE_v0.3_DRAFT.md) — latest working 00G successor for collective false-context convergence. v0.3 Draft preserves the v0.2 paired opaque false/genuine-regime-change fixture, corrected A/B/C/D semantics, source-dependence graph, strong comparator arms and bounded re-entry, while adding DBC-namespaced Q0–Q5 dispositions, explicit S1 authority-current-applicability coverage, bidirectional DBC-C04/C06 routing and numerator/denominator/branch-oracle KPI instrumentation. [`v0.2`](./00G_FAILURE_MODE_COLLECTIVE_FALSE_CONTEXT_CONVERGENCE_v0.2.md) remains the preserved published predecessor; [`v0.1`](./00G_FAILURE_MODE_COLLECTIVE_FALSE_CONTEXT_CONVERGENCE_v0.1.md) remains earlier lineage. It is not W3-admitted, not integrated into 00D execution and not a claim of hallucination immunity.
  - [`baseline/00G_A01_OPENAI_AGENTS_STACK_IMPLEMENTATION_PROFILE_v0.1_DRAFT.md`](./00G_A01_OPENAI_AGENTS_STACK_IMPLEMENTATION_PROFILE_v0.1_DRAFT.md) — source-reviewed OpenAI implementation-trajectory draft for 00G using OAI-G0 standard competent, OAI-G1 defended top-notch and OAI-G2 same-top-under-latent-regime-change paths. It freezes official OpenAI evidence through 24 Sep 2026 and treats multi-agent compaction/source-dependence as a falsifiable transformation test, not a documented vendor failure.
- [`baseline/00H_FAILURE_MODE_BATCH_OPPORTUNITY_BEYOND_AUTHORITY_v0.5_DRAFT.md`](./00H_FAILURE_MODE_BATCH_OPPORTUNITY_BEYOND_AUTHORITY_v0.5_DRAFT.md) — latest working 00H successor for C12 / DBC-C05, with **"The Quiet Four Thousand"** as the primary no-attacker reader frame and **"The Refund Campaign Nobody Approved"** as the V19/V20 adversarial companion. v0.5 Draft preserves the v0.2 Solstice Retail base fixture and Q0–Q5 architecture; the base V1a path requires no attacker—refund #2 is already outside a one-case mandate while adding the V14–V18 Adaptive Strong-Peer Stress Family: authority-binding drift, campaign-membership/aggregation-key invalidation, multi-principal delegated lineage, changed-composition approval and a frozen strong-peer regime mutation. v0.4 additionally adds V19/V20 adaptive delegation / authority-laundering with mandatory U/G/I paired branches and an explicit S8 non-amplification/root-authority-lineage gate; v0.5 restores the base paired silent execution/preservation failure to the front of the reader narrative and makes the adversarial companion concrete as a compromised Customer Operations Dispatcher / supervisor session that may legitimately route and delegate ordinary cases but cannot authorize the common refund campaign, and records an explicit EA gate audit finding no need for an additional non-Requirements gate and defines an **EA0 standard requirements-conforming route** expected to pass U/G/I from the start using S1/S7/S8/S9/S12/S13/S14; the fictional operating model places that Dispatcher in a third-party CRM/helpdesk/BPO chain with possible subcontracted remote staffing, emphasizing that refund is only one downstream ticket outcome rather than the dispatcher's purpose; this records an honest v0.3 scenario-coverage gap without creating a new canonical S/H requirement. [v0.2 Draft](./00H_FAILURE_MODE_BATCH_OPPORTUNITY_BEYOND_AUTHORITY_v0.2_DRAFT.md) and [v0.1](./00H_FAILURE_MODE_BATCH_OPPORTUNITY_BEYOND_AUTHORITY_v0.1.md) remain preserved predecessors. It is not W3-admitted, executed, adopted or validated.
