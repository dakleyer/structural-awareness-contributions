...
- [`baseline/00G_FAILURE_MODE_COLLECTIVE_FALSE_CONTEXT_CONVERGENCE_v0.2.md`](./00G_FAILURE_MODE_COLLECTIVE_FALSE_CONTEXT_CONVERGENCE_v0.2.md) — current published working 00G scenario / quality-gate plan for collective false-context convergence. v0.2 preserves the v0.1 narrative while adding paired false-frame / genuine-regime-change branches, opaque executable fixtures, corrected A/B/C/D semantics, source-dependence and authority separation, Q0–Q5 gates, bounded termination/re-entry and local `00G-A0…A3` comparison arms. [`v0.1`](./00G_FAILURE_MODE_COLLECTIVE_FALSE_CONTEXT_CONVERGENCE_v0.1.md) remains preserved as the predecessor. It is not W3-admitted, not integrated into 00D execution and not a claim of hallucination immunity.
