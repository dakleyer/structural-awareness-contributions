...
> **Current result.** All six principles now have an executable, fixture-bounded leave-one-principle-out harness. The canonical six harnesses contain **101 regression tests**. Supplemental falsification, independent-isolation and cross-scenario reimplementation packages add **27 tests**, for a current registered symbolic campaign surface of **128 tests**.
...
|---|---|---:|---|---|
| **P1 — qualified determination / explicit residual** | [A1 / 00J](./fixtures/00K-A1-P1-00J/README.md) | **13** | typed evidence→proposition schema | **SEMANTIC RECONSTRUCTION**; no TRUE SUBSTITUTE found |
| **P2 — bounded unresolved effort / viable oversight** | [A2 / 00E](./fixtures/00K-A2-P2-00E/README.md) | **13** | finite decision-relevant search + bounded fallback | **SEMANTIC RECONSTRUCTION**; no TRUE SUBSTITUTE found |
| **P3 — no false closure from unresolved state** | [A3 / 00F](./fixtures/00K-A3-P3-00F/README.md) | **15** | explicit three-valued unresolved/non-permission closure | **SEMANTIC RECONSTRUCTION**; no TRUE SUBSTITUTE found |
| **P4 — qualification-preserving handoff / authority lineage** | [A4 / 00H](./fixtures/00K-A4-P4-00H/README.md) | **29** | A2-L explicit root/delegation lineage | **SEMANTIC RECONSTRUCTION**; no TRUE SUBSTITUTE found |
| **P5 — material-change requalification at use time** | [A5 / 00I](./fixtures/00K-A5-P5-00I/README.md) | **14** | full material-basis compare-before-act | **SEMANTIC RECONSTRUCTION**; no TRUE SUBSTITUTE found |
| **P6 — no local→ecosystem promotion / non-substitution** | [A6 / matched-authority 00G](./fixtures/00K-A6-P6-00G/README.md) | **17** | dependency-aware source-independence peer | **SEMANTIC RECONSTRUCTION**; no TRUE SUBSTITUTE found in the isolated fixture |

**Core total: 101 tests.**
...
**Supplemental total: 27 tests.**

**Registered campaign total: 128 tests.**
