...
**MSCA reconciliation note — 23 September 2026:** ACC remains a separately owned governance/participation object, but the [Canonical MSCA Architecture](../../../standards/minimum-sufficient-control/00_CANONICAL_MSCA_ARCHITECTURE.md) defines its operational coupling as a **normative MSCA extension profile**. Extension does not mean subset or inheritance: an ACC may be substantially richer than MSCA and retain semantics that MSCA does not own. An MSCA may contain several compatible ACC profiles for different roles or participant classes; presence in the MSCA does **not** make each profile the ACC of every agent. The participant-specific role-defining ACC is bound through the [MSCA Architectural Role](../../../standards/minimum-sufficient-control/02_MSCA_ARCHITECTURAL_ROLE.md). The companion [ACC Lineage, Identity & Authority Binding Profile](../../../standards/minimum-sufficient-control/01_ACC_LINEAGE_IDENTITY_AUTHORITY_BINDING_PROFILE.md) owns the minimum root/lineage, optional-until-role subject binding, issuer/approval, validity, mutation-envelope and successor-continuity semantics; 01I continues to own the broader participation/governance model. Dynamic role/contract transition, including drift control and legitimate ACC successor/re-contracting, is owned by the [Canonical MSCA Operation & Repositioning](../../../standards/minimum-sufficient-control/04_CANONICAL_MSCA_OPERATION_AND_REPOSITIONING.md) specification.
