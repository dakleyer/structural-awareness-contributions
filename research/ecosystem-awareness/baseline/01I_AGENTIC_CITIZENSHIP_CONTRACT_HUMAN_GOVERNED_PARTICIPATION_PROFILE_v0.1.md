...
**MSCA reconciliation note — 23 September 2026:** ACC remains a separately owned governance/participation object, but the [Canonical MSCA Architecture](../../../standards/minimum-sufficient-control/00_CANONICAL_MSCA_ARCHITECTURE.md) defines its operational coupling as a **normative MSCA extension profile**. Extension does not mean subset or inheritance: an ACC may be substantially richer than MSCA and retain semantics that MSCA does not own. It is loaded into an MSCA instance only after compatibility/applicability qualification. The companion [ACC Lineage, Identity & Authority Binding Profile](../../../standards/minimum-sufficient-control/01_ACC_LINEAGE_IDENTITY_AUTHORITY_BINDING_PROFILE.md) owns the minimum root/lineage, subject-binding, issuer/approval, validity, mutation-envelope and successor-continuity semantics; 01I continues to own the broader participation/governance model.
