# 00H — Case-Study Extensibility Profile — v0.1
...
Primary witness: **P4** for overreach; **P1** for preservation/evidence continuity; **P6** joins common-root composition.

## 2. Inherited requirement route

Base route:

**S1/S2/S8/S11/S14 → T2/T3/T4.**

Where delegation/common-root composition matters:

**S1/S7/S8/S9/S12/S13/S14 → T2/T3/T4.**

The family must preserve both positive controls:

- genuinely authorized campaign → allowed;
- genuinely independent cases → remain independent.
