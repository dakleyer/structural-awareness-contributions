...
**Case-study family / extensibility:** this 100-million-token Meridian story is the **minimum concrete instantiation** of the [00E Compounded Epistemic Collapse case-study family](./00E_CASE_STUDY_EXTENSIBILITY_PROFILE_v0.1.md). Upward/vertical, downward and horizontal extensions are admitted only under the common [A25 extensibility test](./00K_A25_FAILURE_CASE_STUDY_EXTENSIBILITY_AND_CONFORMANCE_TRANSFER_v0.1.md); the token count, industry and company name are not the structural boundary.
