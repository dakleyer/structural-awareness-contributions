...
| **5** | [00G — Collective False-Context Convergence](./00G_FAILURE_MODE_COLLECTIVE_FALSE_CONTEXT_CONVERGENCE_v0.2.md) | How can correlated narrative/signalling produce false contextual convergence and authority confusion? | **Additive annex / candidate scenario**; 00D integration pending |
...
5. [00G — Collective False-Context Convergence ("Bar-to-Napoleon" Cascade) v0.2](./00G_FAILURE_MODE_COLLECTIVE_FALSE_CONTEXT_CONVERGENCE_v0.2.md): the current published working candidate. It preserves the memorable narrative but moves the executable test to paired opaque false-frame / genuine-regime-change branches, corrects A/B/C/D semantics, adds source-dependence and authority separation, Q0–Q5 gates, bounded termination/re-entry and strong local `00G-A0…A3` arms. v0.1 remains preserved as the predecessor. It is not yet integrated into 00D/W3 execution and is not a claim of hallucination immunity.
