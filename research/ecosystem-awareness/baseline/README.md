...
5. [00G — Collective False-Context Convergence ("Bar-to-Napoleon" Cascade)](./00G_FAILURE_MODE_COLLECTIVE_FALSE_CONTEXT_CONVERGENCE_v0.1.md): a synthetic multi-agent stress test for correlated narrative reinforcement, mission displacement, false corroboration and authority/admissibility confusion. It compares ordinary/strong conventional/interoperability arms against a minimum EA-signalling arm with scoped A/B/C/D, provenance/source-dependence, selective MSCA/ACC projections and authority references. It is an additive candidate scenario, not yet integrated into 00D, not an executed result and not a claim of hallucination immunity.
