...
6. [00H — Batch Opportunity Beyond Authority ("The Quiet Four Thousand")](./00H_FAILURE_MODE_BATCH_OPPORTUNITY_BEYOND_AUTHORITY_v0.1.md): a synthetic C12 / DBC-C05 reference failure scenario for a beneficial, well-evidenced but currently unauthorized batch action. It freezes a preregistered materiality rule, separates non-adversarial aggregate-authority failure from deliberate cap decomposition, uses the namespaced DBC re-contracting sequence and defines Q0–Q5 quality gates with local 00H-A0…A3 arms. It is a documented candidate scenario, not yet W3-admitted or executed.
