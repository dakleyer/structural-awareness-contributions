...
6. [Concrete candidate architecture — 00 topology](./00_CANONICAL_ARCHITECTURE_TOPOLOGY.md), followed by 01–04 below: EA's general conceptual, functional and interface design. FG-TIDA-specific mappings begin only in the separate [FG-TIDA application package](../fg-tida/README.md).
7. [00D — Canonical Architecture Benchmark and Reference-Scenario Evidence](./00D_CANONICAL_ARCHITECTURE_BENCHMARK_AND_REFERENCE_SCENARIO_EVIDENCE_v0.2.md): the single benchmark route. It integrates EA-H1–EA-H4, B0–B3 fair comparison, existing agent benchmarks and primary-source corroboration of the mechanisms in 00E/00F. The newer 00G signalling scenario remains additive until 00D is explicitly revised to include it. It distinguishes formal results, controlled experiments, investigated occurrences and market/standard evidence, and states exactly what each source does and does not establish.
