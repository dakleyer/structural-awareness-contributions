...
- 00I semantic TOCTOU / stale decision-basis applicability;
  - current scenario: [00I v0.3 Draft — The Patch That Undid the Fix](./baseline/00I_FAILURE_MODE_SEMANTIC_TOCTOU_v0.3_DRAFT.md), with Q0–Q6 gates, OOTB/top-notch/frozen-top-notch-under-drift trajectories, V11 adaptive source/policy/dependency drift, positive continuity control and CAND-R4 check-to-act binding probe; not yet W3-admitted or executable;
