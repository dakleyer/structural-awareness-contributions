...
**00H reader framing:** the primary public story remains the no-attacker **Quiet Four Thousand**. It has two paired silent failures: unauthorized helpful overreach and discovery-without-preservation. The outsourced Dispatcher is the V19/V20 adversarial hardening, not the premise of the scenario.
