...
| How do the 00E–00J failure fixtures become reusable successful cases? | [A25 failure-family extensibility](./baseline/00K_A25_FAILURE_CASE_STUDY_EXTENSIBILITY_AND_CONFORMANCE_TRANSFER_v0.1.md) · [A26 Failure→Success Model Cases](./baseline/00K_A26_FAILURE_TO_SUCCESS_MODEL_CASE_AND_EXTENSIBILITY_v0.1.md) | Six paired Success Model Cases → up/down/horizontal extensions; no new S# unless A21 is falsified |
