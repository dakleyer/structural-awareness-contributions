...
| **RS-00E-Q1e** — degraded GEEW input | S3/S5/S14 → T1/T2/T4 → H1/H5/H6; material-break precision, false continuation, false containment, requalification latency. | Late, threshold-miscalibrated or unqualified regime signal; its representation/context/freshness limitation and affected decision frame. | ICR where the GEEW signal crosses an interface; otherwise N/A. | Deterministic stipulative oracle knows the injected signal limitation; a qualified-signal branch is the control. | B3 inherits detector confidence, continues without qualification or adds false containment in the qualified-signal control. | A strong peer closes the stated gap within tolerance. | Planned Stage 0. | Planned atomic dependency boundary. |
| **RS-00E-Q2** — human approval under saturation | S4/S5/S14 → T2/T3/T4 → H1/H4/H6; human-capacity binding, Type-1→Type-2 forced closure, response margin, deadline pass. | Reviewer demand/capacity, binding deadline, current evidence, approval status, bounded fallback and explicit `UNKNOWN`. | Relevant ICR where the reviewer/approval handoff crosses an interface; otherwise N/A. | Deterministic stipulative capacity schedule; expected result distinguishes approval from new evidence. | B3 treats approval as new determination or leaves unbounded HOLD. | Pre-registered peer preserves the limitation and applies an authorized bounded fallback within tolerance; Q2-N0 supplies sufficient-capacity control. | Planned Stage 0. | Planned primary 00E coverage gap. |
| **RS-00E-Q4** — bounded requalification | S3/S4/S5/S10/S14 → T1/T2/T3/T4 → H1/H5/H6; false continuation, false containment, deadline pass, response margin, evidence yield, total burden and marginal decision value. | Material residual after declared additional search, binding deadline, authority, scarce-resource ledger, permitted bounded experiment and `NO COMMITMENT` posture. | ICR where residual/requalification status crosses an interface; otherwise N/A. | Deterministic stipulative `O_ref` declares whether the residual is reducible inside the horizon. | B3 searches without bound, silently closes, or remains contained when the negative-control residual is reducible. | A pre-registered strong peer reaches an equally qualified outcome within common tolerance, or B3 incurs avoidable false containment, deadline loss or burden. | Planned Stage 0. | Planned Q4 fixture with reducible-residual negative control. |
| **RS-00E-N0** — valid continuity / null | S3/S5/S14 → T1/T2/T4 → H1/H5/H6; material-break precision, false-containment cost, burden. | No material break, normal basis still valid, expected continuation and false-positive cost. | ICR positive fixture when an interface route applies. | Deterministic stipulative oracle. | B3 detects/requalifies without a material break. | B3 exceeds the pre-registered false-containment/burden tolerance against B1. | Planned Stage 0. | Planned negative/null control. |
| **RS-00F-C1** — competing corridor postures | S1/S3/S5/S9/S11/S14 → T1/T2/T3/T4 → H1/H2/H3/H4/H5/H6; incompatible-posture exposure, conflict precision, deadline pass. | Shared resource-time segment, scope, source dependency, A/B/NORMAL/HOLD, authority/expiry and residual. | Composition-Critical ICR for each exercised interface handoff. | Deterministic stipulative oracle identifies conflict; it does not decide precedence. | B3 hides conflict, arbitrates without authority or misses deadline. | Pre-registered B1/B2 exposes conflict and preserves a qualified partial result within tolerance. | Planned Stage 0. | Planned primary mobility fixture. |
| **RS-00F-C2** — precedence absent | S1/S9/S13/S14 → T2/T3/T4 → H2/H4; authority-field completeness, handoff integrity, action/outcome trace. | Competing directives, source-owned precedence reference absent, authority/intervention history and escalation receiver. | Composition-Critical ICR where directives cross interfaces. | Deterministic stipulative oracle. | B3 resolves precedence or hides the absent owner. | A configuration exposes conflict and the named/absent precedence owner with equal/lower burden. | Planned Stage 0. | Planned boundary fixture. |
| **RS-00F-N0** — no material shared conflict | S3/S5/S9/S14 → T1/T2/T4 → H1/H5/H6; false-containment cost, burden and deadline pass. | Compatible postures or separated resource-time use; expected no unnecessary hold. | ICR positive fixture where applicable. | Deterministic stipulative oracle. | B3 raises material conflict/containment without the injected break. | B3 is less viable than the pre-registered B1 tolerance. | Planned Stage 0. | Planned negative/null control. |
...
The Q4 **cost of action or inaction relative to `O_ref`** is a local fixture measure, not a new canonical KPI. It selects the applicable existing measures from 00: false containment or false-positive response cost, deadline pass, remaining response margin, total decision burden, decision-relevant evidence yield and marginal decision value. The record declares its numerator, denominator and the scarce-resource unit—such as decision time, reviewer attention or a regulatory window. Results are not aggregated across fixtures unless that unit and conversion rule are the same and pre-registered.
