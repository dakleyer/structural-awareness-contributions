...
```mermaid
flowchart TB
    J[OÜ JUBAP<br/>project owner, applicant, research integrator and IP steward]
    I[Ivan Abril<br/>project architect and principal researcher]
    E[EIS Estonia / RUP<br/>programme authority and assessment route]
    TIS[TalTech Information Systems Group<br/>prospective supporting R&D group<br/>systems, information readiness and data governance]
    TNG[TalTech Next Gen Digital State Research Group<br/>prospective supporting R&D group<br/>digital transformation and governance]
    S[Exploratory scientific dialogue<br/>University of Tartu, Tallinn University and QAVA / University of Valencia]
    C[Cybernetica AS<br/>exploratory research and implementation fit]
    H[Audited high-performing teams<br/>evidence source for practice criteria]
    P[Prospective initiatives<br/>pre-commitment test settings]
    A[Independent assessors and auditors<br/>reliability and reproducibility checks]

    I --> J
    J -->|preliminary consultation and assessment package| E
    J -. intended procurement; no concluded role .-> TIS
    J -. intended procurement; no concluded role .-> TNG
    J -. exploratory; no partnership or endorsement .-> S
    J -. exploratory; no partnership or endorsement .-> C
    H -->|auditable practice evidence| J
    P -->|sealed readings and later outcomes| J
    A -->|independent assessment evidence| J
```
